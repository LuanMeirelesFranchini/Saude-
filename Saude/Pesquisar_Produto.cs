    ...
    public partial class Pesquisar_Produto : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                MySqlDataAdapter da = new MySqlDataAdapter("Select * from tblProduto  where Pro_Nome like '%" + Txt_Produto.Text + "%';", objCnx);
        ...
        private void Pesquisar_Produto_Load(object sender, EventArgs e)
        {
            try
            {
